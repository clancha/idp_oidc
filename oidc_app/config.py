...
class Config:
    ...
    # WebAuthn Cloud    
    WSCD_URL = os.getenv("WSCD_URL", "https://wscd.carloslancha.es") # Poner aqui la dirección del WSCD (esta vacía porque no hay dominio y usamos trycloudflare de momenot)
